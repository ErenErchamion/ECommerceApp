...
class ProductViewPagerAdapter (var list: List<Int>, var ctx: Context) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        var view = layoutInflater.inflate(R.layout.productviewpageritem,container,false)
